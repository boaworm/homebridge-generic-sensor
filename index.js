...
function HTTP_GENERIC_SENSOR(log, config) {
    this.log = log;
    ...
    this.unit = utils.enumValueOf(SensorUnit, config.unit, SensorUnit.Float);
    if (!this.unit) {
        this.unit = SensorUnit.Float;
        this.log.warn(`${config.unit} is an unsupported sensor unit! Using default (float)!`);
    }
...
HTTP_GENERIC_SENSOR.prototype = {
    ...
    getServices: function () {
        ...
        informationService
            ...
            .setCharacteristic(Characteristic.SerialNumber, "BOA01")
